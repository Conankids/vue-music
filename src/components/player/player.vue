...
export default {
  ...
  computed: {
    ...
    iconMode() {
      return this.mode === playMode.loop ? 'icon-loop' : this.mode === playMode.sequence ? 'icon-sequence' : 'icon-random'
    },
    playIcon() {
  ...
  methods: {
    ...
    changeMode() {
      ...
      if (this.mode === playMode.random) {
        list = shaffle(this.sequenceList)
      } else {
